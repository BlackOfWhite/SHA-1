...
/**
 * Created by niewinskip on 2016-09-29.
 */
public class Main {
    ...
    public static String msg = "Piotr";
...
//    (A left rotate 5) + F + E + K + (the current word).
    private static void crossingFunction (String currentWord){
    ...
    private static void presentOutput() {
    ...
    private static String convertBinaryToHex (String bin) {
        ...
        for (int x = 0; x < bin.length(); x++) {
            ...
            if ((x + 1) % 4 == 0) {
                if (sum >= 0 && sum <= 9) {
                    ...
                    switch (sum) {
                        case 10 : hexOutput.append('A'); break;
                        case 11 : hexOutput.append('B'); break;
                        case 12 : hexOutput.append('C'); break;
                        case 13 : hexOutput.append('D'); break;
                        case 14 : hexOutput.append('E'); break;
                        case 15 : hexOutput.append('F'); break;
                    }
                }
                sum = 0;
                multi = 8;
    ...
    private static String ROTLeftFunction (String s, int rot) {
        if (rot < 1) {
            return s;
        }
    ...
    private static char XOROperatinon (char a, char b) {
       if ((a == '0' && b == '0') || (a == '1' && b == '1')) {
           return '0';
        } else {
            return '1';
    ...
    private static char OROperatinon (char a, char b) {
        if (a == '0' && b == '0') {
            return '0';
        } else {
            return '1';
    ...
    private static char ANDOperatinon (char a, char b) {
        if (a == '1' && b == '1') {
            return '1';
        } else {
            return '0';
    ...
    private static char NOTOperatinon (char a) {
         return a == '1' ? '0' : '1';
    }
